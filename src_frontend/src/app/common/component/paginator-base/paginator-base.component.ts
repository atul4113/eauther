...
@Component({
    ...
    template: `
        <div class="paginator">
            ...
            <button (click)="pageChanged(1)" [ngClass]="{'mdl-button--accent': pageIndex === 1}" 
                class="mdl-button mdl-js-button mdl-button--primary">
                1
            </button>
            <button *ngIf="showLeftMore" (click)="setPrevRange()" 
                class="mdl-button mdl-js-button mdl-button--primary">
                ...
            </button>
            <button *ngFor="let p of pagesRange" (click)="pageChanged(p)"  [ngClass]="{'mdl-button--accent': pageIndex === p}" 
                class="mdl-button mdl-js-button mdl-button--primary">
                {{ p }}
            </button>
            <button *ngIf="showRightMore" (click)="setNextRange()" 
                class="mdl-button mdl-js-button mdl-button--primary">
                ...
            </button>
            <button *ngIf="pagesCount > 1" (click)="pageChanged(pagesCount)"  [ngClass]="{'mdl-button--accent': pageIndex === pagesCount}" 
                class="mdl-button mdl-js-button mdl-button--primary">
                {{ pagesCount }}
            </button>
            <button (click)="nextPage()" [disabled]="pageIndex === pagesCount || pagesCount === 0"
                class="mdl-button mdl-js-button mdl-button--primary action-button">
...
export class PaginatorBaseComponent implements OnChanges, OnInit {
    ...
    private setPageRange (index: number) {

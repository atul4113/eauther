import { Directive, AfterViewInit, OnDestroy, ElementRef, Renderer, Input } from "@angular/core";
...
export class PutFooterBottom implements AfterViewInit, OnDestroy {
    ...
    ngAfterViewInit () {
        ...
        this.onResize();
        this.windowListenResizeFunc = this._renderer.listenGlobal('window', 'resize', () => this.onResize());
    }
    ...
    private onResize () {
        if (this.native && this.footer) {
            ...
            if (headerHeight === 0 || footerHeight < 265) {
                ...
                let minHeight = windowHeight - headerHeight - footerHeight - this.paddingAndMargin;

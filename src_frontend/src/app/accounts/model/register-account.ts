...
export const ADULT_REQUIRED_FIELDS = [
    "adultEmail",
    "adultFirstname",
    "adultLastname",
];
export const REGULATION_REQUIRED_FIELDS = [
    "regulationAgreementInfo",
    "regulationInformationInfo",
    "regulationMarketing",
];
...
export class RegisterAccount {
    ...
    public regulationAgreementInfo: boolean = false;
}

...
export class AccountsService {
    ...
    public register (account: RegisterAccount): Observable<any> {
        return this._restClient.postPublic(ACCOUNT_REGISTER_URL, new RawRegisterAccount(account));
    }

    public activate (key: string): Observable<any> {
        return this._restClient.postPublic(ACCOUNTS_ACTIVATE_URL, {'activation_key': key});
    }
}

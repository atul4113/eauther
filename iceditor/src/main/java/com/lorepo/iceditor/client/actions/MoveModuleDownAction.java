...
public class MoveModuleDownAction extends AbstractPageAction {
	public MoveModuleDownAction(AppController controller) {
		super(controller);
	}
	...
	public void execute() {
		...
		selectedPage.getModules().moveModuleDown(module);

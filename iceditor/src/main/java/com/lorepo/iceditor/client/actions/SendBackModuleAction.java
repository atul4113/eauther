...
public class SendBackModuleAction extends AbstractPageAction{

	public SendBackModuleAction(AppController controller) {
		super(controller);
	}
	...
	public void execute() {
		...
		selectedPage.getModules().sendBackModule(module);

...
class QueueTestCase(FormattedOutputTestCase):       
    def setUp(self):
        super(FormattedOutputTestCase, self).setUp()
        mock('libraries.utility.queues.trigger_backend_task')
    
    def tearDown(self):
        super(FormattedOutputTestCase, self).tearDown()
        restore()
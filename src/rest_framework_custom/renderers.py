...
import six
from rest_framework import exceptions, status  # ✅ CORRECT
from drf_spectacular import serializers  # ✅ CORRECT
...
def parse_header(header):
    return HeaderParser().parsestr(header)
...
class HTMLFormRenderer(BaseRenderer):
    ...
    format = 'form'
    charset = 'utf-8'
    template_pack = 'rest_framework_custom/vertical/'
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    media_type = 'text/html'
    format = 'api'
    template = 'rest_framework_custom/api.html'
    filter_template = 'rest_framework_custom/filters/base.html'
    charset = 'utf-8'
    ...
    def get_rendered_html_form(self, data, view, method, request):
        ...
        with override_method(view, request, method) as request:
            ...
            return form_renderer.render(
                ...
                {'style': {'template_pack': 'rest_framework_custom/horizontal'}}
            )
    ...
    def get_context(self, data, accepted_media_type, renderer_context):
        ...
        context = {
            ...
            'version':drf_spectacular.__version__  # Get the version dynamically
,
            'paginator': paginator,
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        ...
        ret = render_to_string(template, context, request=renderer_context['request'])
...
class AdminRenderer(BrowsableAPIRenderer):
    template = 'rest_framework_custom/admin.html'
    format = 'admin'

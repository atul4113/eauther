...
def optional_login(request):
    ...
    """
    try:
        login_url = reverse('rest_framework_custom:login')
...
def optional_logout(request, user):
    ...
    """
    try:
        logout_url = reverse('rest_framework_custom:logout')
    except NoReverseMatch:
...
def format_value(value):
    ...
    if value is None or isinstance(value, bool):
        ...
        if any([isinstance(item, (list, dict)) for item in value]):
            template = loader.get_template('rest_framework_custom/admin/list_value.html')
        else:
            template = loader.get_template('rest_framework_custom/admin/simple_list_value.html')
        context = {'value': value}
        return template_render(template, context)
    elif isinstance(value, dict):
        template = loader.get_template('rest_framework_custom/admin/dict_value.html')
        context = {'value': value}
        return template_render(template, context)

...
if 'crispy_forms' in settings.INSTALLED_APPS and crispy_forms and django_filters:
    ...
    filter_template = 'rest_framework_custom/filters/django_filter_crispyforms.html'
    ...
    filter_template = 'rest_framework_custom/filters/django_filter.html'
...
class SearchFilter(BaseFilterBackend):
    ...
    template = 'rest_framework_custom/filters/search.html'

...
class SimpleRouter(BaseRouter):
    ...
    def get_routes(self, viewset):
        ...
        """
        known_actions = flatten([list(route.mapping.values()) for route in self.routes if isinstance(route, Route)])
    ...
    def get_lookup_regex(self, viewset, lookup_prefix=''):
        ...
        Note that lookup_prefix is not used directly inside REST rest_framework_custom

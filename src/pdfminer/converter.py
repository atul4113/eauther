...
class PDFLayoutAnalyzer(PDFTextDevice):
    ...
    def paint_path(self, gstate, stroke, fill, evenodd, path, stroke_color=None, fill_color=None):
        ...
        if shape == 'mlllh':
            ...
            if ((x0 == x1 and y1 == y2 and x2 == x3 and y3 == y0) or
                ...
                self.cur_item.add(LTRect(gstate.linewidth, (x0, y0, x2, y2), stroke=stroke_color, fill=fill_color))
                return
        # other shapes
        pts = []
        for p in path:
        ...
        self.cur_item.add(LTCurve(gstate.linewidth, pts, stroke=stroke_color, fill=fill_color))
        return

...
class LTCurve(LTComponent):
    ...
    def __init__(self, linewidth, pts, stroke=None, fill=None):
        LTComponent.__init__(self, get_bound(pts))
        self.pts = pts
        self.linewidth = linewidth
        self.stroke = [int(a*255) for a in stroke] if stroke is not None else None# scale to 0-255
        self.fill = [int(a*255) for a in fill] if fill is not None else None# scale to 0-255
        return
...
class LTRect(LTCurve):
    ...
    def __init__(self, linewidth, xxx_todo_changeme1, stroke=None, fill=None):
        (x0, y0, x1, y1) = xxx_todo_changeme1
        LTCurve.__init__(self, linewidth, [(x0, y0), (x1, y0), (x1, y1), (x0, y1)], stroke, fill)
        return

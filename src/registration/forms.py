...
class RegistrationForm(forms.Form):
    ...
    username.widget.attrs['class'] = 'registrationInput'
    email.widget.attrs['class'] = 'registrationInput'
    password1.widget.attrs['class'] = 'registrationInput'
    password2.widget.attrs['class'] = 'registrationInput'

...
urlpatterns = [
    url(r'^lessons/edited$', RecentlyEditedLessonsView.as_view(), name='recently_edited_lessons'),
    url(r'^lessons$', MyContentView.as_view(trash=False), name='mycontent'),
    url(r'^(?P<space_id>\d+)/lessons$', MyContentView.as_view(trash=False), name='mycontent'),
    url(r'^(?P<space_id>\d+)/addons$', AddonsView.as_view(), name='addons'),
    url(r'^lessons/trash$', MyContentView.as_view(trash=True), name='mycontent'),
    url(r'^(?P<space_id>\d+)/trash$', MyContentView.as_view(trash=True), name='mycontent'),
    url(r'^lessons_paginated$', ContentView.as_view(trash=False), name='mycontent'),
    url(r'^(?P<space_id>\d+)/lessons_paginated$', ContentView.as_view(trash=False), name='mycontent'),
    url(r'^(?P<space_id>\d+)/trash_paginated$', ContentView.as_view(trash=True), name='mycontent'),
    url(r'^categories$', MyContentCategoriesView.as_view(), name='my_content_categories'),
    url(r'^(?P<content_id>\d+)$', SingleContentView.as_view(), name='content_details'),
    url(r'^(?P<content_id>\d+)/history$', ContentHistoryView.as_view(), name='content_history'),
    url(r'^(?P<content_id>\d+)/assets$', AssetsView.as_view(), name='assets'),
    url(r'^(?P<content_id>\d+)/metadata$', ContentMetadataView.as_view(), name='metadata'),
    url(r'^(?P<content_id>\d+)/pages_metadata$', ContentPagesMetadataView.as_view(), name='pages_metadata'),
    url(r'^(?P<content_id>\d+)/delete$', MyContentDeleteView.as_view(), name='content_delete'),
    url(r'^corporate/(?P<content_id>\d+)/delete$', MyContentCorporateDeleteView.as_view(), name='content_corporate_delete'),
    url(r'^(?P<content_id>\d+)/undelete', MyContentUndeleteView.as_view(), name='content_undelete'),
    url(r'^(?P<content_id>\d+)/(?P<space_id>\d+)/copy$', MyContentCopyView.as_view(), name='content_copy'),
    url(r'^(?P<content_id>\d+)/copy_to_account', MyContentCopyToAnotherUserView.as_view(), name='copy_to_account'),
    url(r'^(?P<content_id>\d+)/(?P<version>\d+)/export$', MyContentExportView.as_view(), name='content_export'),
    url(r'^(?P<content_id>\d+)/makepublic$', MyContentPublishView.as_view(), name='content_makepublic'),
    url(r'^(?P<content_id>\d+)/update_template$', MyContentUpdateTemplateView.as_view(), name='content_update_template'),
    url(r'^(?P<content_id>\d+)/(?P<space_id>\d+)/page_list$', MyContentListMergePagesView.as_view(), name='page_list'),
    url(r'^(?P<space_id>\d+)/merge$', MyContentMergeView.as_view(), name='merge'),
    url(r'^edit_lesson_token$', MyContentEditLessonToken.as_view(), name='edit_lesson_token'),
    url(r'^edit_addon_token$', MyContentEditAddonToken.as_view(), name='edit_addon_token'),
    url(r'^(?P<content_id>\d+)/upload_asset$', MyContentUploadAsset.as_view(), name='upload_asset'),
    url(r'^(?P<content_id>\d+)/upload_asset_package$', MyContentUploadAssetPackage.as_view(), name='upload_asset_package'),
    url(r'^set_version/(?P<content_id>\d+)/(?P<version_id>\d+)$', MyContentSetCurrentVersion.as_view(), name='set_current_version'),
    url(r'^(?P<content_id>\d+)/bugs', include('lorepo.api.v2.bugtrack_api')),
    url(r'^refresh_content_index/(?P<content_id>\d+)$', MyContentFixdb.as_view(), name='content_fixdb'),
    ]
